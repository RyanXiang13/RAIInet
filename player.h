...
public:
    static std::unique_ptr<Player> create(int id, bool isTurn, std::vector<int> a, std::vector<std::string> l, std::vector<std::string> kl, std::vector<std::unique_ptr<Link>> dl);
    int getPlayerID() const;
    bool getIsTurn() const;
    const std::vector<int> &getAbilities() const;
    const std::vector<std::string> &getOwnedLinks() const;
    ...
    void removeOwnedLink(std::string s);
